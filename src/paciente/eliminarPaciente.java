...
public class eliminarPaciente extends javax.swing.JFrame {
    ...
    public eliminarPaciente() {
        ...
        Object columns[] = {"count", "Fecha", "Id", "Nombre", "Edad", "Genero", "Direccion", "Numero telefono", "EstadoCivil", "Enfermedad", "Numero Habitacion"};
    ...
    private void initComponents() {
        ...
        jLabel14.setText("Eliminar paciente ");
        ...
        getAccessibleContext().setAccessibleName("Eliminar Paciente");
    ...
    private void jPanel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel1MouseClicked
        ...
        try {
            ps = connection.prepareStatement(sql);
            ps.execute();
            JOptionPane.showMessageDialog(null, "paciente" + search + "ha sido eliminado");
            defaultTableModel.getDataVector().removeAllElements();
            defaultTableModel.fireTableDataChanged();
            loadData();
            connection.close();
        } catch (SQLException e) {
            JOptionPane.showMessageDialog(null, "Paciente nombrado " + search + "NO ENCONTRADO");
        }
