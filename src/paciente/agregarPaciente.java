...
public class agregarPaciente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnLimpiarPaciente = new javax.swing.JLabel();
        ...
        Gender.setText("Dirección ");

        pPhoneField.setText("+55");
        ...
        jLabel9.setText("Nombre de la enfermedad");
        ...
        jLabel13.setText("No. de sala/habitación");
        ...
        btnAgregarPaciente.setFont(new java.awt.Font("Arial", 0, 24)); // NOI18N
        ...
        jPanel6Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel6Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(btnAgregarPaciente, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        ...
        btnLimpiarPaciente.setFont(new java.awt.Font("Arial", 0, 23)); // NOI18N
        btnLimpiarPaciente.setForeground(new java.awt.Color(255, 255, 255));
        btnLimpiarPaciente.setText("Limpiar");
        btnLimpiarPaciente.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btnLimpiarPacienteMouseClicked(evt);
            }
        });
        jPanel7.add(btnLimpiarPaciente);
        btnLimpiarPaciente.setBounds(25, 10, 80, 43);
    ...
    private void btnAgregarPacienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAgregarPacienteMouseClicked
        ...
        if (connection != null) {
            String fecha = pDateField.getText();
            String id = pIdField.getText();
            String nombre= pNameField.getText();
            int edad = Integer.parseInt(pAgeField.getText());
            String genero = (String) pGenderField.getSelectedItem();
            String direccion = pAddressField.getText();
            String telefono = pPhoneField.getText();
            String estadocivil = (String) pStatusField.getSelectedItem();
            String enfermedad = pDiseaseField.getText();
            int  habitacion = Integer.parseInt(pRoomField.getText());
            String sql = "insert into paciente(fecha,id,nombre,edad,genero,direccion,telefono,estadocivil,enfermedad,habitacion) values (?,?,?,?,?,?,?,?,?,?)";
            try {
                ...
                prp.setString(6, direccion);
                prp.setString(7, telefono);
                prp.setString(8, estadocivil);
                prp.setString(9, enfermedad);
                prp.setInt(10, habitacion);
                prp.execute();
    ...
    private void btnLimpiarPacienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnLimpiarPacienteMouseClicked
        pDateField.setText("");
        pNameField.setText("");
        pAgeField.setText("");
        pIdField.setText("");
    ...
    }//GEN-LAST:event_btnLimpiarPacienteMouseClicked
    ...
    private javax.swing.JLabel btnLimpiarPaciente;
