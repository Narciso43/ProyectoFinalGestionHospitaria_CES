...
public class actividadMedico extends javax.swing.JFrame {
    ...
    public actividadMedico(String pName) {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Bienvenidos al Panel Medico");
        ...
        jLabel10.setText("Actividad del médico ");
        ...
        jLabel3.setText("Área del médico ");
    ...
    private void jLabel8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel8MouseClicked
        ...
        String sql = "SELECT pName FROM citas WHERE dName = '" + findName + "'";
        try {
            ...
            sendName = getPname;
            Cita appointment = new Cita(sendName);
            appointment.setVisible(true);
            dispose();

        } catch (SQLException e) {
            JOptionPane.showMessageDialog(null, "La lista de citas está vacía");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(actividadMedico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new actividadMedico().setVisible(true);
        });
    }
