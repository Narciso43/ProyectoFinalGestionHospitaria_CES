...
public class eliminarMedico extends javax.swing.JFrame {
    ...
    public eliminarMedico() {
        ...
        Object columns[] = {"Serial", "Dia de ingreso", "Id", "Nombre", "Edad", "Genero", "Grupo Sanguineo", "Departamento", "Numero de telefono", "Correo", "Estado civil", "Direccion", "Numero de habitacion", "Usuario"};
    ...
    public void loadData() {
        ...
        String sql = "select count,fecha,id,nombre,edad,genero,sangre,departamento,telefono,correo,estadocivil,direccion,habitacion,usuario from medicos";
        try {
    ...
    private void initComponents() {
        ...
        jLabel14.setText("Eliminar médico ");
    ...
    private void jPanel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel1MouseClicked
        ...
        String sql = "Delete from medicos where nombre ='" + search + "'";
        try {
            ps = connection.prepareStatement(sql);
            ps.execute();
            JOptionPane.showMessageDialog(null, "MEDICO " + search + " ELIMINADO");
            defaultTableModel.getDataVector().removeAllElements();
            defaultTableModel.fireTableDataChanged();
            loadData();
            connection.close();
        } catch (SQLException e) {
            JOptionPane.showMessageDialog(null, "NOMBRE " + search + " NO ENCONTRADO");
        }
    ...
    private void dDeletebtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dDeletebtnMouseClicked
        ...
        try {
            ps = connection.prepareStatement(sql);
            ps.execute();
            JOptionPane.showMessageDialog(null, "Medico " + search + " ha sido eliminado");
            defaultTableModel.getDataVector().removeAllElements();
            defaultTableModel.fireTableDataChanged();
            loadData();
            connection.close();
        } catch (SQLException e) {
            JOptionPane.showMessageDialog(null, "Medico " + search + " no encontrado");
        }
