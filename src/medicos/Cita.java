...
public class Cita extends javax.swing.JFrame {
    ...
    public Cita(String Nname) {
        ...
        String sql = "SELECT id,edad,genero FROM paciente WHERE nombre = '" + pName + "'";
        try {
            ps = connection.prepareStatement(sql);
            rs = ps.executeQuery();
            rs.first();
            String Id = rs.getString("id");
            int iage = rs.getInt("edad");
    ...
    private void initComponents() {
        ...
        pNamelbl.setText("Nombre del paciente: ");
        ...
        appointmentBtn.setText("Detalles ");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(appointmentBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 139, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(494, 494, 494))
        );
    ...
    private void jLabel21MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel21MouseClicked
        actividadMedico dActivity = new actividadMedico();
    ...
    private void appointmentBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_appointmentBtnActionPerformed
        detallesPaciente pDetails = new detallesPaciente(pName);
