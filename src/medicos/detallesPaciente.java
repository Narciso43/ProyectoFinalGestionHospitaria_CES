...
public final class detallesPaciente extends javax.swing.JFrame {
    ...
    public detallesPaciente(String name) {
        initComponents();
        ImageIcon ic = new ImageIcon(getClass().getResource("/Images/hospital.png"));
        this.setIconImage(ic.getImage());
        data = name;
        Object columns[] = {"Count", "FECHA", "ID", "NOMBRE", "EDAD", "GENERO", "DIRECCION", "NUMERO/TELEFONO", "ESTADOCIVIL", "ENFERMEDAD", "HABITACION"};
    ...
    public void loadData() {
        ...
        String sql = "select count,fecha,id,nombre,edad,genero,direccion,telefono,estadocivil,enfermedad,habitacion from paciente where nombre = '" + data + "'";
        try {
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Detalles del paciente ");
        ...
        getAccessibleContext().setAccessibleName("¡Detalles del paciente IMSS!");
    ...
    private void jLabel21MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel21MouseClicked
        Cita appointment = new Cita(data);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new detallesPaciente().setVisible(true);
        });
    }
