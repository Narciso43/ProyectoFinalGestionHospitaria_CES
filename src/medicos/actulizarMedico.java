...
public class actulizarMedico extends javax.swing.JFrame {
    ...
    public actulizarMedico() {
        initComponents();
        ImageIcon ic = new ImageIcon(getClass().getResource("/Images/hospital.png"));
        this.setIconImage(ic.getImage());

        Object columns[] = {"Serial", "Fecha", "Id", "Nombre", "Edad", "Genero", "Grupo Sanguineo", "Departamento", "Numer/Telefono", "Correo", "Estado Civil", "Address", "Numero/Habitacion", "Usuario", "Contraseña"};
    ...
    public void loadData() {
        ...
        String sql = "select count,fecha,id,nombre,edad,genero,sangre,departamento,telefono,correo,estadocivil,direccion,habitacion,usuario,contraseña from medicos";
        try {
            ...
            while (rs.next()) {
                ...
                columnData[14] = rs.getString("contraseña");
    ...
    private void initComponents() {
        ...
        setTitle("¡Actualice la información del médico!");

        jPanel7.setBackground(new java.awt.Color(0, 153, 153));

        jLabel14.setFont(new java.awt.Font("Arial", 0, 24)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(255, 255, 255));
        jLabel14.setText("¡Actualizar la información del médico!");
        ...
        getAccessibleContext().setAccessibleName("¡Actualice la información del médico!");
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        connection = Connector.ConnectDb();
        String sql = "Update medicos set fecha = '" + fecha + "', id = '" + id + "', nombre = '" + nombre + "', edad = '" + edad + "', genero = '" + genero + "', sangre = '" + sangre + "', departamento = '" + departamento + "', telefono = '" + telefono + "', correo = '" +  correo + "', estadocivil = '" + estdocivil + "', direccion = '" + direccion + "', habitacion = '" + habitacion+ "', usuario = '" + usuario + "', contraseña = '" + contraseña + "' where count = '" + count + "'";
        try {
            ps = connection.prepareStatement(sql);
            ps.execute();
            ...
            loadData();
            JOptionPane.showMessageDialog(null, "Datos Actulizas");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            new actulizarMedico().setVisible(true);
        });
    }
