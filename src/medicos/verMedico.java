...
public class verMedico extends javax.swing.JFrame {
    ...
    public verMedico() {
        ...
        Object columns[] = {"Serial", "Dia de ingreso", "Id", "Nombre", "Edad", "Genero", "Grupo Sanguineo", "Departamento", "Numero de telefono", "Correo", "Estado Civil", "Direccion", "Numero de habitacion", "Usuario", "Contraseña"};
    ...
    private void initComponents() {
        ...
        rPassBtn.setText("Mostrar contraseñas ");
    ...
    private void rPassBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rPassBtnActionPerformed
        if (rPassBtn.isSelected()) {
            rPassBtn.setText("Ocultar contraseñas");
            ...
            try {
                ...
                columnData[12] = rs.getInt("habitacion");
                columnData[13] = rs.getString("usuario");
                columnData[13] = rs.getString("contraseña");
                defaultTableModel.addRow(columnData);
            }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, e);
            ...
            rPassBtn.setText("Mostrar contraseña");
            defaultTableModel.getDataVector().removeAllElements();
            defaultTableModel.fireTableDataChanged();
            connection = Connector.ConnectDb();
            String sql = "select count,fecha,id,nombre,edad,genero,sangre,departamento,telefono,correo,estadocivil,direccion,habitacion,usuario from medicos";
