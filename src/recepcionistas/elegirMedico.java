...
public class elegirMedico extends javax.swing.JFrame {
    ...
    public elegirMedico() {
        ...
        Object columns[] = {"Serial", "Fecha de Ingreso", "Id", "Nombre", "Edad", "Genero", "Grupo Sanguineo", "Departamento", "Numero de telefono", "Correo", "EstadoCivil", "Direccion", "Numero de Habitacion", "Usuario"};
    ...
    private void initComponents() {
        ...
        setTitle("Elegir Medico");

        jPanel5.setBackground(new java.awt.Color(0, 153, 153));

        jLabel12.setFont(new java.awt.Font("Arial", 0, 24)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(255, 255, 255));
        jLabel12.setText("Establecer cita");
        ...
        dASearchbtn1.setText("Siguiente");
        ...
        doctorhind.setText("Seleccione un médico y presione Siguiente");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(doctorhind, javax.swing.GroupLayout.DEFAULT_SIZE, 23, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void dASearchbtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dASearchbtnMouseClicked
        ...
        String sql = "select count,fecha,id,nombre,edad,genero,sangre,departamento,telefono,correo,estadocivil,direccion,habitacion,usuario from medicos where departamento = '" + searchKey + "'";
        try {
    ...
    private void jPanel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel1MouseClicked
        ...
        defaultTableModel.fireTableDataChanged();
        String searchKey = (String) dSearchbox.getSelectedItem();
        String sql = "select count,fecha,id,nombre,edad,genero,sangre,departamento,telefono,correo,estadocivil,direecion,habitacion,usuario from medicos where departamento = '" + searchKey + "'";
        try {
            ps = connection.prepareStatement(sql);
            rs = ps.executeQuery();
            Object columnData[] = new Object[14];
    ...
    private void dASearchbtn1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dASearchbtn1MouseClicked
        ...
        elegirPaciente cPatient = new elegirPaciente();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new elegirMedico().setVisible(true);
        });
    }
