...
public class buscarRecepcionista extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel14.setText("Buscar Recepcionista");
        ...
        jLabel1.setText("Nombre de Recepcionista");
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        ...
        String sql = "select count,fecha,id,nombre,edad,genero,sangre,correo,telefono,direccion,estadocivil,usuario from recepcionista where nombre = '" + searchKey + "'";
        try {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new buscarRecepcionista().setVisible(true);
        });
    }
