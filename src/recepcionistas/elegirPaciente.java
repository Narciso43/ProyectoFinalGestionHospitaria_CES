...
public class elegirPaciente extends javax.swing.JFrame {
    ...
    public elegirPaciente() {
        initComponents();
        ImageIcon ic = new ImageIcon(getClass().getResource("/Images/hospital.png"));
        this.setIconImage(ic.getImage());
        Object columns[] = {"Fecha", "Id", "Nombre", "Edad", "Genero", "Direccion", "Telefono", "Estado/Civil", "Enfermedad", "Numero de habitacion"};
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(dASearchbtn1, javax.swing.GroupLayout.DEFAULT_SIZE, 99, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        ...
        String sql = "select fecha,id,nombre,edad,genero,direccion,telefono,estadocivil,enfermedad,habitacion from paciente where nombre = '" + searchKey + "'";
        try {
            ps = connection.prepareStatement(sql);
            rs = ps.executeQuery();
            Object columnData[] = new Object[10];
            while (rs.next()) {
                columnData[0] = rs.getString("fecha");
                columnData[1] = rs.getString("id");
                columnData[2] = rs.getString("nombre");
                columnData[3] = rs.getInt("edad");
                columnData[4] = rs.getString("genero");
                columnData[5] = rs.getString("direccion");
                columnData[6] = rs.getString("telefono");
                columnData[7] = rs.getString("estadocivil");
                columnData[8] = rs.getString("enfermedad");
                columnData[9] = rs.getInt("habitacion");
    ...
    private void dASearchbtn1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dASearchbtn1MouseClicked
        ...
        connection = Connector.ConnectDb();
        String sql = "insert into citas (dName,pName,room) values (?,?,?)";
        try {
            ps = connection.prepareStatement(sql);
            ...
            ps.setInt(3, droom);
            ps.execute();
            JOptionPane.showMessageDialog(null, "PACIENTE " + pname + " CITA CON MEDICO " + dName + " EN EL CONSULTORIO " + droom);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new elegirPaciente().setVisible(true);
        });
    }
