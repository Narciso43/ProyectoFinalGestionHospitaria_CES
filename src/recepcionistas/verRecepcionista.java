...
public class verRecepcionista extends javax.swing.JFrame {
    ...
    public verRecepcionista() {
        ...
        Object columns[] = {"Serial", "Fecha de ingreso", "Id", "Nombre", "Edad", "Genero", "Grupo Sangeuineo", "Correo", "Numero de telefono", "Direccion", "Estado/Civil", "Usuario", "Contraseña"};
    ...
    public final void loadData() {
        ...
        String sql = "select count,fecha,id,nombre,edad,genero,sangre,correo,telefono,direccion,estadocivil,usuario from recepcionista";
        try {
    ...
    private void initComponents() {
        ...
        jLabel14.setText("Ver Recepcionista");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(rPassBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 182, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void rPassBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rPassBtnActionPerformed
        if (rPassBtn.isSelected()) {
            rPassBtn.setText("Ocultar contraeña");
            ...
            rPassBtn.setText("Ver contraseña");
            defaultTableModel.getDataVector().removeAllElements();
            defaultTableModel.fireTableDataChanged();
            connection = Connector.ConnectDb();
            String sql = "select count,fecha,id,nombre,edad,genero,sangre,correo,telefono,direccion,estadocivil,usuario from recepcionista";
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            new verRecepcionista().setVisible(true);
        });
    }
