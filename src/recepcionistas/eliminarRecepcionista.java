...
public class eliminarRecepcionista extends javax.swing.JFrame {
    ...
    public eliminarRecepcionista() {
        ...
        Object columns[] = {"Serial", "Fecha de ingreso", "Id", "Nombre", "Edad", "Genero", "Grupo Sanguineo", "Correo", "Numero de Telefono", "Direccion", "Estado/Civil", "Usuario"};
    ...
    public void loadData() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                columnData[9] = rs.getString("estadocivil");
                columnData[10] = rs.getString("usuario");
                columnData[11] = rs.getString("contraseña");
    ...
    private void initComponents() {
        ...
        setTitle("Eliminar Recepcionista.");

        jPanel7.setBackground(new java.awt.Color(0, 153, 153));

        jLabel14.setFont(new java.awt.Font("Arial", 0, 24)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(255, 255, 255));
        jLabel14.setText("Eliminar Recepcionista");
    ...
    private void jPanel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel1MouseClicked
        ...
        String sql = "Delete from recepcionista where nombre ='" + search + "'";
        try {
            ps = connection.prepareStatement(sql);
            ps.execute();
    ...
    private void rDeletebtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_rDeletebtnMouseClicked
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Paciente nombreado " + search + " extraviado");
        }
    }//GEN-LAST:event_rDeletebtnMouseClicked

    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            new eliminarRecepcionista().setVisible(true);
        });
    }
