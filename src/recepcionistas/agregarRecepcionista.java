...
public class agregarRecepcionista extends javax.swing.JFrame {
    ...
    private void addDctorbtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addDctorbtnMouseClicked
        ...
        if (connection != null) {
            ...
            String contraseña = String.valueOf(rPassField.getPassword());
            String sql = "insert into recepcionista(fecha,id,nombre,edad,genero,sangre,correo,telefono,direccion,estadocivil,usuario,contraseña) values (?,?,?,?,?,?,?,?,?,?,?,?)";
            try {
